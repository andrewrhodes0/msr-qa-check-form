...
def submit_button_click(self, **event_args):
    ...
    for i in range(1, 6):  # Assuming you have 5 boards
        ...
        moe = getattr(self, f'text_box_board_{i}_moe').text
    ...
    if check_meta_data_ok and check_board_data_ok:
        ...
        anvil.server.call('add_check', qa_name, shift, product_size, length, board_data, comments)
        # You might want to add some user feedback here, e.g., a message that data was submitted successfully.
    else:
        # You might want to handle the case where some data is missing, e.g., show an error message.
        pass
